...
// import { FiInstagram, FiTwitter, FiMail, FiArrowUp, FiHeart, FiBook, FiCoffee, FiFacebook, FiMessageCircle, FiCode, FiGithub, FiLinkedin } from 'react-icons/fi';
          ...
          <div className="flex flex-col items-center gap-4 sm:gap-5">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 text-center">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-stone-200 hover:text-white transition-colors duration-200 font-semibold text-sm sm:text-base hover:underline decoration-stone-500 underline-offset-4"
              >
                Shadrack Bett
              </a>
            </div>
            
            {/* Contact Links - Responsive: Compact Mobile, Spacious Desktop */}
            <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 w-full max-w-2xl px-4 sm:px-0">
              <a
                href="https://kipkorir.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-stone-800/40 backdrop-blur-sm border border-stone-700/40 
                         px-3 py-2 sm:px-4 sm:py-2.5 rounded-lg hover:bg-stone-700/60 hover:border-stone-600/60
                         transition-all duration-300 group flex items-center justify-center gap-2 sm:gap-2.5 
                         flex-1 sm:flex-initial min-w-[100px] sm:min-w-0"
                aria-label="Portfolio"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hidden sm:flex bg-stone-800/40 backdrop-blur-sm border border-stone-700/40 
                         px-3 py-2 sm:px-4 sm:py-2.5 rounded-lg hover:bg-stone-700/60 hover:border-stone-600/60
                         transition-all duration-300 group items-center justify-center gap-2 sm:gap-2.5 
                         flex-initial min-w-0"
                aria-label="GitHub"
              >
                <FiGithub className="text-stone-400 group-hover:text-white transition-colors text-sm sm:text-base" />
                <span className="text-stone-300 group-hover:text-white text-xs sm:text-sm font-medium">GitHub</span>
              </a>
              ...
              <a
                ...
                aria-label="LinkedIn"
              >
                <FiLinkedin className="text-stone-400 group-hover:text-white transition-colors text-sm sm:text-base" />
                <span className="text-stone-300 group-hover:text-white text-xs sm:text-sm font-medium">LinkedIn</span>
              </a>
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="bg-gradient-to-r from-green-500/20 to-green-600/20 backdrop-blur-sm 
                         border border-green-600/40 px-3 py-2 sm:px-4 sm:py-2.5 rounded-lg 
                         hover:from-green-500/30 hover:to-green-600/30 hover:border-green-500/60
                         transition-all duration-300 group flex items-center justify-center gap-2 sm:gap-2.5 
                         w-full sm:w-auto"
                aria-label="WhatsApp"
            ...
            {/* Call to Action with Badge */}
            <div className="flex items-center justify-center gap-2 sm:gap-2.5 text-stone-500 text-xs text-center px-4">
